# Contributing to bids-hub

Thank you for your interest in contributing to bids-hub!
...
git clone https://github.com/The-Obstacle-Is-The-Way/bids-hub.git
cd bids-hub
...
See [docs/explanation/architecture.md](docs/explanation/architecture.md#adding-a-new-dataset) for the step-by-step guide.
...
See [UPSTREAM_BUG.md](UPSTREAM_BUG.md) for the `Sequence(Nifti())` sharding bug and our workaround.
